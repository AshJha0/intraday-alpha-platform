...
| paper evidence for the lifecycle, registry untouched | done | `paper_evidence.json` (`PaperEvidence` x-version 2); the `paper_ic_tracking` gate fails EQ01 / EQ03 on this data — a finding, not a promotion |
