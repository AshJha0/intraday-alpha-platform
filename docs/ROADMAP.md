...
| honest result stated | done | −22.65 USD on 3,176 shares: +0.039 bps of alpha against −0.40 bps of execution cost; `alpha.cost_negative: true` in `report.json` |
